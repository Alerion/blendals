...
class MidiTrackToCurve:
    ...
    def apply_track_to_curve(self, animation_curve: FCurve, midi_track: MidiTrack) -> None:
    ...
    def _add_note_to_animation_curve(self, animation_curve: FCurve, note: Note) -> None:
        ...
        set_keyframe_point(animation_curve, frame=peak_frame, value=self.max_value)
